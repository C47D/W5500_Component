// ======================================================================
// test_print_remote_mac_ip_isr.v generated from TopDesign.cysch
// 06/16/2018 at 10:27
...
module SW_Tx_UART_v1_50_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e52b017c-8202-48f5-8ae2-ba41a5fe0100/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("46ae69f7-ee25-4f34-8f2f-2dcb61b0b66d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("31e841d3-e772-4726-9d13-fa8acd5f9f8b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__W5500_ISR_net;
	wire [0:0] tmpFB_0__W5500_ISR_net;
	wire [0:0] tmpIO_0__W5500_ISR_net;
	electrical [0:0] tmpSIOVREF__W5500_ISR_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		W5500_ISR
		 (.oe(tmpOE__W5500_ISR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__W5500_ISR_net[0:0]}),
		  .io({tmpIO_0__W5500_ISR_net[0:0]}),
		  .siovref(tmpSIOVREF__W5500_ISR_net),
		  .interrupt({Net_11}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__W5500_ISR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
